  ...
  return (
    <>
      ...
      <div className="px-6 py-4 lg:px-12 flex flex-col ">
        ...
        <a 
        href="https://github.com/neopromic/for-devs" 
        target="_blank">
        ...
        <div className="w-full h-80 border rounded my-4 flex">
          <div className="rounded bg-violet-500/5 h-full w-full p-6 flex flex-col items-center justify-center">
            <h2 className="font-bold text-xl lg:text-3xl tracking-tighter leading-tight">Colabore!</h2>
            <p className="text-muted-foreground text-center leading-relaxed ">O ForDevs visa criar uma comunidade acolhedora para desenvolvedores, promovendo colaboração, aprendizado e inovação.</p>
          </div>
          <Separator orientation="vertical" />
          <div className="rounded bg-violet-500/5 h-full w-full p-6 flex flex-col items-center justify-center">
            <h2 className="font-bold text-xl lg:text-3xl tracking-tighter leading-tight">Heading</h2>
